...
An interactive MATLAB-based tool designed to simplify and visualize publicly available data from NASA’s Artemis Program, making space exploration more accessible to a general audience.

---

## 1. Project Overview

The Artemis Mission Data Explorer bridges the gap between complex NASA mission data and public understanding. While mission reports and datasets are publicly available, they are often difficult for non-experts to interpret.
